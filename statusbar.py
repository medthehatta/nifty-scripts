...
def dz_volume():
	...
	if on:
		...
		return i("spkr_01","")+" "+pbar(percent,"") #add fully charged or charging?
...
ITEMS=[("downloaded",dz_downloaded,30),("mail",dz_mail,60), ("vol",dz_volume,3), ("wifi",dz_wifi,30), ("batt",dz_battery,30), ("date",dz_date,30)]
